...
class Chat {
  ...
  start() {
    ...
    return _asyncToGenerator(function* () {
      // start streaming
      try {
        yield _this.obs.call("StartStream");
  ...
  stop() {
    ...
    return _asyncToGenerator(function* () {
      // stop streaming
      try {
        yield _this2.obs.call("StopStream");
  ...
  startStopRec(bool) {
    ...
    return _asyncToGenerator(function* () {
      if (bool) {
        try {
          var res = yield _this3.obs.call("StartRecording");
  ...
  switch(sceneName) {
    ...
    return _asyncToGenerator(function* () {
      ...
      if (sceneName == null) return _this4.say(_this4.locale.switch.error); //const res = search(sceneName, this.obsProps.scenes, { keySelector: obj => obj.name });
      //const scene = res.length > 0 ? res[0].name : sceneName;
      //log.info("SSSSSSSCEEEEENE : " + scene);

      try {
        yield _this4.obs.call("SetCurrentProgramScene", {
          "sceneName": sceneName
        });
    ...
    return _asyncToGenerator(function* () {
      if (!_this5.isRefreshing) {
        try {
          ...
          yield _this5.obs.call("SetCurrentProgramScene", {
            "sceneName": _config.default.obs.refreshScene
          });
          ...
          setTimeout(() => {
            _this5.obs.call("SetCurrentProgramScene", {
              "sceneName": lastScene
            });
      ...
      if (availableRequests.includes("RestartMedia")) {
        ...
        s.mediaSources.filter(e => e.mediaState == "playing").forEach( /*#__PURE__*/function () {
          var _ref = _asyncToGenerator(function* (e) {
            ...
            if (input !== null && input !== void 0 && input.startsWith("rtmp") || input !== null && input !== void 0 && input.startsWith("srt")) {
