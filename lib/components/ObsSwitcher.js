...
class ObsSwitcher extends _events.default {
  constructor(address, password, low, normal, offline, lowBitrateTrigger) {
    ...
    this.scenes = null;
    this.obs.connect(this.address, this.password) //{ address: this.address, password: this.password }
    .catch(e => {
      // handle this somewhere else
      log.info(e);
    });
    this.obs.on("ConnectionClosed", this.onDisconnect.bind(this));
    this.obs.on("Identified", this.onAuth.bind(this));
    ...
    return _asyncToGenerator(function* () {
      ...
      if (bitrate !== null) {
        ...
        if (["nimble", "srt-live-server"].includes(_config.default.rtmp.server)) {
          _this.isLive && canSwitch && (bitrate === 0 && currentScene.name !== _this.previousScene && (_this.obs.call("SetCurrentProgramScene", {
            "sceneName": _this.previousScene
          }), _this.switchSceneEmit("live", _this.previousScene), log.info("Stream went online switching to scene: \"".concat(_this.previousScene, "\""))), (rtt < _this.highRttTrigger || rtt >= _this.highRttTrigger) && bitrate <= _this.lowBitrateTrigger && currentScene.name !== _this.lowBitrateScene && bitrate !== 0 && (_this.obs.call("SetCurrentProgramScene", {
            "sceneName": _this.lowBitrateScene
          }), _this.previousScene = _this.lowBitrateScene, _this.switchSceneEmit("lowBitrateScene"), log.info("Low bitrate detected switching to scene: \"".concat(_this.lowBitrateScene, "\""))), rtt >= _this.highRttTrigger && bitrate > _this.lowBitrateTrigger && currentScene.name !== _this.lowBitrateScene && bitrate !== 0 && (_this.obs.call("SetCurrentProgramScene", {
            "sceneName": _this.lowBitrateScene
          }), _this.previousScene = _this.lowBitrateScene, _this.switchSceneEmit("lowBitrateScene"), log.info("High RTT detected switching to scene: \"".concat(_this.lowBitrateScene, "\""))), rtt < _this.highRttTrigger && bitrate > _this.lowBitrateTrigger && currentScene.name !== _this.normalScene && (_this.obs.call("SetCurrentProgramScene", {
            "sceneName": _this.normalScene
          ...
          _this.isLive && canSwitch && (bitrate === 0 && currentScene.name !== _this.previousScene && (_this.obs.call("SetCurrentProgramScene", {
            "sceneName": _this.previousScene
          }), _this.switchSceneEmit("live", _this.previousScene), log.info("Stream went online switching to scene: \"".concat(_this.previousScene, "\""))), bitrate <= _this.lowBitrateTrigger && currentScene.name !== _this.lowBitrateScene && bitrate !== 0 && (_this.obs.call("SetCurrentProgramScene", {
            "sceneName": _this.lowBitrateScene
          }), _this.previousScene = _this.lowBitrateScene, _this.switchSceneEmit("lowBitrateScene"), log.info("Low bitrate detected switching to scene: \"".concat(_this.lowBitrateScene, "\""))), bitrate > _this.lowBitrateTrigger && currentScene.name !== _this.normalScene && (_this.obs.call("SetCurrentProgramScene", {
            "sceneName": _this.normalScene
          }), _this.previousScene = _this.normalScene, _this.switchSceneEmit("normalScene"), log.info("Switching to normal scene: \"".concat(_this.normalScene, "\""))));
        }
      } else {
        ...
        canSwitch && currentScene.name !== _this.offlineScene && (_this.obs.call("SetCurrentProgramScene", {
          "sceneName": _this.offlineScene
  ...
  streamStopped() {
    ...
    return _asyncToGenerator(function* () {
      ...
      if (canSwitch) {
        _this3.obs.call("SetCurrentProgramScene", {
          "sceneName": _this3.offlineScene
        });
      }
    })();
  }
  ...
  getSceneList() {
    ...
    return _asyncToGenerator(function* () {
      var list = yield _this4.obs.call("GetSceneList");
      _this4.scenes = list.scenes.map(scene => scene.sceneName);
      ;
      _this4.currentScene = list.currentProgramSceneName;
    })();
  }
  ...
  canSwitch() {
    ...
    return _asyncToGenerator(function* () {
      yield _this5.getSceneList();
      var currentScene = _this5.currentScene; //await this.obs.call("GetCurrentScene");

      console.log("Current: " + currentScene);
      var canSwitch = currentScene == _this5.lowBitrateScene || currentScene == _this5.normalScene || currentScene == _this5.offlineScene;
